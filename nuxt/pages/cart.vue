  ...
  <div id="detailed-cart">
    ...
    <div class="detailed-cart">
      <div v-if="totalItems" class="detailed-cart__aside">
        <OrderSummary
          :products="getPopulatedProducts"
          :shipping-methods="shippingMethods"
          :total-items="getProductsQuantity"
          :subtotal="getSubtotalPrice"
          @click:next="goToCheckout"
        />
      </div>
        ...
        <transition name="sf-fade" mode="out-in">
          ...
          >
            <transition-group name="sf-fade" tag="div">
              <SfCollectedProduct
                v-for="product in getPopulatedProducts"
                :key="product.id"
                ...
                @click:remove="removeHandler(product.id)"
              >
                <template #input>
                  <div class="sf-collected-product__quantity-wrapper">
                    <!-- $event is variable which is the original DOM event (or custom payload from a custom event). -->
                    <SfQuantitySelector
...
import { OrderSummary } from '~/storefront/src/examples/pages/detailed-cart/_internal/index.js'
...
export default {
  ...
  created() {
    this.$store.dispatch('cart/populateProducts')
  },
  methods: {
    ...mapActions('ui', [
