  ...
  <div id="checkout">
    ...
    <div class="actions">
      <SfButton
        ...
        @click="currentStep < 2 ? currentStep++ : pay()"
...
import {
  ...
  OrderSummary,
  OrderReview,
} from '@storefront-ui/vue/src/examples/pages/checkout/_internal/index.js'
export default {
  name: 'Checkout',
  components: {
    SfSteps,
  ...
  data() {
    return {
      currentStep: 0,
      steps: ['Go to payment', 'Pay for order', 'Confirm and pay'],
