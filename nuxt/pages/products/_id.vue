<template>
  <div id="product">
    ...
    />
    <div class="product">
      <SfGallery :images="product.image" class="product__gallery" />
      <div class="product__info">
        ...
        <div class="product__price-and-rating">
          <!-- TODO add special price, discount percent -->
          <SfPrice :regular="product.price.regular" />
          <div>
            <div class="product__rating">
              <SfRating :score="rating.rate" :max="rating.max" />
...
export default {
  ...
  data() {
    return {
      /* TODO add rating and reviews, sizes */
      rating: {
        rate: 4,
        max: 5,
      },
  ...
  async asyncData(context){
    /* BUG product image should be as productDelete.images */
    const product = await context.store.dispatch("product/getProduct", {id: context.params.id})
    return {product}
  }
